...
function activate()
    ...
    -- Row 7: Filter List Text Box (Cols 1..4, row_span = 1 for uniform grid height)
    w_filter_list = dialog:add_text_input("(No filter segments added yet)", 1, 7, 4, 1)

    -- Row 8: Export & Control Buttons (Col 1 = Export, Col 2 = Clear, Col 3..4 = Toggle)
